...
export const TraineeProfileSchema = z.object({
  ...
  privacyBadges: VisibilitySchema,
  privacyFriendCount: VisibilitySchema,
  id: z.string().cuid(),
  userId: z.string(),
  ...
  showcaseBadgeIds: z.string().array(),
...
export const TraineeProfileOptionalDefaultsSchema = TraineeProfileSchema.merge(z.object({
  ...
  privacyBadges: VisibilitySchema.optional(),
  privacyFriendCount: VisibilitySchema.optional(),
  id: z.string().cuid().optional(),
  country: z.string().optional(),
  leaderboardOptIn: z.boolean().optional(),
  showcaseBadgeIds: z.string().array().optional(),
