...
export const UserSchema = z.object({
  ...
  phoneNumber: z.string().regex(/^\+[1-9]\d{6,14}$/, { message: "Phone must be in E.164 format (e.g. +447123456789)" }).nullable(),
  ...
  smsNotifyBookings: z.boolean(),
  smsNotifyBookingReminders: z.boolean(),
...
export const UserOptionalDefaultsSchema = UserSchema.merge(z.object({
  ...
  smsNotifyBookings: z.boolean().optional(),
  smsNotifyBookingReminders: z.boolean().optional(),
