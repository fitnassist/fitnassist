...
export const PricingCard = ({
  ...
  const price =
    billingPeriod === "ANNUAL" ? info.annualPricePence : info.monthlyPricePence;
      ...
      <div className="bg-gradient-to-br from-[#4cd6c3] to-[#44c1af] text-center py-6 px-4">
        ...
        <div className="mt-2">
          <div className="text-3xl font-bold text-white">
            {formatPricePence(
              Math.round(tier === "FREE" ? 0 : monthlyEquivalent),
            )}
          </div>
          <p className="text-sm text-white/80 uppercase tracking-wider mt-1">
            Per Month
          </p>
        </div>
      </div>
