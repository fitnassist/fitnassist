    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:py-16 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 space-y-8 text-muted-foreground">
        <section>
          ...
          <p className="mt-2">
            By accessing or using Fitnassist ("the platform"), you agree to be bound by these Terms
        ...
        <section>
          ...
          <p className="mt-2">
            Fitnassist is a platform that connects personal trainers with trainees. We provide tools
            for trainer discovery, profile management, messaging, and connection requests. We do not
            directly provide personal training services.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-6">
            ...
            <li>
              Attempt to access other users' accounts or private information without authorisation.
            </li>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            error-free, or secure. We do not endorse, verify, or guarantee any trainer listed on the
            platform.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            To the fullest extent permitted by law, Fitnassist shall not be liable for any indirect,
            incidental, special, consequential, or punitive damages arising from your use of the
            platform. This includes, but is not limited to, any injuries, losses, or damages
            resulting from personal training services arranged through the platform.
          </p>
        </section>
