      ...
      <div className="mt-8 space-y-8 text-muted-foreground">
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-6">
            ...
            <li>
              <strong>Profile information:</strong> for trainers, this includes bio, qualifications,
              certifications, services offered, profile photos, and location data.
            </li>
            <li>
            ...
            <li>
              <strong>Newsletter subscriptions:</strong> email addresses provided for our newsletter.
            </li>
            <li>
              <strong>Support enquiries:</strong> name, email, and message content when you contact
              us through our support form.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            geographic coordinates) to enable location-based search functionality. This information
            is visible on your public profile and in search results. You can update or remove your
            location at any time through your profile settings.
          </p>
        </section>

        <section>
          <h2 className="text-xl font-semibold text-foreground">5. Information Sharing</h2>
          <p className="mt-2">We do not sell your personal information. We may share your information in the following circumstances:</p>
          <ul className="mt-2 list-disc space-y-1 pl-6">
            <li>
