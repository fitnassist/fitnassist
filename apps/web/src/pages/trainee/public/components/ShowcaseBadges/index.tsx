...
const ICON_MAP: Record<string, LucideIcon> = {
  Flame, Dumbbell, Utensils, Heart, Users, Target, Compass, Footprints, Droplets, Moon, Smile, Camera, Award, Star, Trophy, Zap,
};

const TIER_STYLES = {
  BRONZE: 'text-amber-700 dark:text-amber-400 bg-amber-100 dark:bg-amber-950/40 border-amber-300 dark:border-amber-700',
  SILVER: 'text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-800/40 border-slate-300 dark:border-slate-600',
