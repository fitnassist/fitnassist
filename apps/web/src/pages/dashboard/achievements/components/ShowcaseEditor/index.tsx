  ...
  return (
    <div className="rounded-xl border bg-card p-4">
      <div className="mb-3 flex items-center justify-between">
        ...
        <span className="text-xs text-muted-foreground">{showcaseBadges.length} / {maxSlots} slots</span>
      </div>
      <p className="mb-4 text-xs text-muted-foreground">
        Choose up to {maxSlots} badges to display on your profile. Click &quot;Showcase&quot; on any earned badge below.
      </p>
