    ...
    <div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-3xl">
          ...
          <CardContent className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                id="pricePence"
                type="number"
                {...register('pricePence', { valueAsNumber: true })}
                placeholder="e.g. 1999 for £19.99"
              />
              {errors.pricePence && (
                <p className="text-sm text-destructive">{errors.pricePence.message}</p>
              )}
            </div>
            <div className="space-y-2">
              <Label htmlFor="compareAtPricePence">Compare-at Price (pence, optional)</Label>
              <Input
                id="compareAtPricePence"
                type="number"
                {...register('compareAtPricePence', { valueAsNumber: true })}
        ...
        {productType === 'DIGITAL' && (
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Digital File</CardTitle>
            </CardHeader>
            <CardContent>
              {digitalFileUrl ? (
              ...
              <p className="text-xs text-muted-foreground mt-2">
                PDF, ZIP, or any file up to 100MB. Buyers can download after purchase.
              </p>
            </CardContent>
          </Card>
        )}
