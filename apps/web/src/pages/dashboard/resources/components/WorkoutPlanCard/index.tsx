...
import { Pencil, Trash2, ClipboardList, Dumbbell, Users } from 'lucide-react';
...
export const WorkoutPlanCard = ({ plan, onDelete, isDeleting }: WorkoutPlanCardProps) => {
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-2">
                <div className="min-w-0">
                  <Link
                    to={routes.dashboardWorkoutPlanEdit(plan.id)}
                  ...
                  <div className="flex items-center gap-3 mt-1.5 text-xs text-muted-foreground">
                    <span className="flex items-center gap-1">
                      ...
                      {plan._count.exercises} exercise{plan._count.exercises !== 1 ? 's' : ''}
                    </span>
                    <span>
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  <Link to={routes.dashboardWorkoutPlanEdit(plan.id)}>
