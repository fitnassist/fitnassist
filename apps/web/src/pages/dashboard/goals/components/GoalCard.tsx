    ...
    <div className={compact ? undefined : 'p-4 sm:p-5'}>
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          <div
            className={`mt-0.5 shrink-0 rounded-md p-2 ${isTarget ? 'bg-blue-500/10 text-blue-500' : 'bg-purple-500/10 text-purple-500'}`}
          >
          ...
          <div>
            <div className="mb-1.5 flex items-center justify-between text-sm">
              <span className="text-muted-foreground">
                ...
                {goal.habitEntryType &&
                  ` (${ENTRY_TYPE_LABELS[goal.habitEntryType] ?? goal.habitEntryType})`}
              </span>
